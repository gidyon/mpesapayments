...
protoc_mpesa_stk.v2:
	@protoc -I=$(API_IN_PATH) -I=third_party --go-grpc_out=$(API_OUT_PATH)/stk/v2 --go-grpc_opt=paths=source_relative --go_out=$(API_OUT_PATH)/stk/v2 --go_opt=paths=source_relative stk.v2.proto
	@protoc -I=$(API_IN_PATH) -I=third_party --grpc-gateway_out=logtostderr=true,paths=source_relative:$(API_OUT_PATH)/stk/v2 stk.v2.proto
	@protoc -I=$(API_IN_PATH) -I=third_party --openapiv2_out=logtostderr=true,repeated_path_param_separator=ssv:$(OPEN_API_V2_OUT_PATH) stk.v2.proto
...
protoc_b2c.v2:
	@protoc -I=$(API_IN_PATH) -I=third_party --go-grpc_out=$(API_OUT_PATH)/b2c/v2 --go-grpc_opt=paths=source_relative --go_out=$(API_OUT_PATH)/b2c/v2 --go_opt=paths=source_relative b2c.v2.proto
	@protoc -I=$(API_IN_PATH) -I=third_party --grpc-gateway_out=logtostderr=true,paths=source_relative:$(API_OUT_PATH)/b2c/v2 b2c.v2.proto
	@protoc -I=$(API_IN_PATH) -I=third_party --openapiv2_out=logtostderr=true,repeated_path_param_separator=ssv:$(OPEN_API_V2_OUT_PATH) b2c.v2.proto

copy_documentation:
	@cp -r $(OPEN_API_V2_OUT_PATH) cmd/apidoc/dist

protoc_all: protoc_c2b.v1 protoc_mpesa_stk.v1 protoc_mpesa_stk.v2 protoc_b2c.v1 protoc_b2c.v2 copy_documentation
