...
func (_m *LNMAPIMock) ArchiveTransactions(ctx context.Context, in *mpesapayment.ArchiveTransactionsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *mpesapayment.ArchiveTransactionsRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *mpesapayment.ArchiveTransactionsRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *LNMAPIMock) SaveScopes(ctx context.Context, in *mpesapayment.SaveScopesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *emptypb.Empty
	if rf, ok := ret.Get(0).(func(context.Context, *mpesapayment.SaveScopesRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*emptypb.Empty)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *mpesapayment.SaveScopesRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
