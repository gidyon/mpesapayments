...
// StkPushAPIClient is an autogenerated mock type for the StkPushAPIClient type
type StkPushAPIClient struct {
	mock.Mock
}

// CreateStkPayload provides a mock function with given fields: ctx, in, opts
func (_m *StkPushAPIClient) CreateStkPayload(ctx context.Context, in *stk.CreateStkPayloadRequest, opts ...grpc.CallOption) (*stk.StkPayload, error) {
...
func (_m *StkPushAPIClient) GetStkPayload(ctx context.Context, in *stk.GetStkPayloadRequest, opts ...grpc.CallOption) (*stk.StkPayload, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *StkPushAPIClient) InitiateSTKPush(ctx context.Context, in *stk.InitiateSTKPushRequest, opts ...grpc.CallOption) (*stk.InitiateSTKPushResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *StkPushAPIClient) ListStkPayloads(ctx context.Context, in *stk.ListStkPayloadsRequest, opts ...grpc.CallOption) (*stk.ListStkPayloadsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *StkPushAPIClient) ProcessStkPayload(ctx context.Context, in *stk.ProcessStkPayloadRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *StkPushAPIClient) PublishAllStkPayload(ctx context.Context, in *stk.PublishAllStkPayloadRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *StkPushAPIClient) PublishStkPayload(ctx context.Context, in *stk.PublishStkPayloadRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
