...
var (
	...
	certFile = flag.String("cert", "/Users/jessegitaka/Desktop/tpgo/certs/localhost/cert.pem", "PKI Public Key file")
	keyFile  = flag.String("key", "/Users/jessegitaka/Desktop/tpgo/certs/localhost/key.pem", "PKI Private Key file")
